...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-ZulipReader/Locksmith.framework"
  install_framework "Pods-ZulipReader/Realm.framework"
  install_framework "Pods-ZulipReader/RealmSwift.framework"
